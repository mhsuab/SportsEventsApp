...
class CustomBottomNavBarCollection extends StatefulWidget {
  CustomBottomNavBarCollection({
    Key? key,
  ...
  final List<CustomBottomNavBar> collection;
  ...
  @override
  _CustomBottomNavBarCollectionState createState() =>
      _CustomBottomNavBarCollectionState();
}

class _CustomBottomNavBarCollectionState
    extends State<CustomBottomNavBarCollection>
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      padding:
          widget.collection[widget.sportIndex].bottomBarTheme.contentPadding,
      decoration:
          widget.collection[widget.sportIndex].bottomBarTheme.decoration,
      child: Column(
        children: <Widget>[
          Row(
      ...
      mainActionButton: MainActionButton(
        ...
        mainActionButtonTheme: MainActionButtonTheme(
            ...
            icon: CircleAvatar(
              radius: 25.0,
              backgroundImage:
                  AssetImage(widget.collection[widget.sportIndex].logoImgPath),
            )),
        arrowAnimation: _arrowAnimation,
        arrowAnimationController: _arrowAnimationController,
        enable: true,
      ),
      items: widget.collection[widget.sportIndex].items
          .asMap()
          .map(
            (i, e) => MapEntry(
              i,
              BottmBarItemController(
                ...
                theme: widget.collection[widget.sportIndex].bottomBarTheme,
              ),
            ),
          )
          .values
  ...
  double get _bottomBarHeigth {
    final t = widget.collection[widget.sportIndex].bottomBarTheme;
